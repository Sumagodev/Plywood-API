...
export const verifyPayment = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    return res.status(statusCode).json({
      ...
      message: message,
      orderId: orderId,
      orderStatus: updatedPayment?.statusResponse?.status,
      txn_id: updatedPayment?.statusResponse?.txn_id,
      effective_amount: updatedPayment?.statusResponse?.effective_amount,
      txn_uuid: updatedPayment?.statusResponse?.txn_uuid,
      date_created: updatedPayment?.statusResponse?.date_created,
      last_updated: updatedPayment?.statusResponse?.last_updated,
      customer_email: updatedPayment?.statusResponse?.customer_email,
      customer_phone: updatedPayment?.statusResponse?.customer_phone,
      customer_id: updatedPayment?.statusResponse?.customer_id,
      status: updatedPayment?.statusResponse?.status,
