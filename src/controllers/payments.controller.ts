...
export const verifyPayment = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    return res.status(statusCode).json({
      ...
      date_created:statusResponse?.date_created,
      last_updated: statusResponse?.last_updated,
      customer_email: statusResponse?.customer_email,
      customer_phone: statusResponse?.customer_phone,
