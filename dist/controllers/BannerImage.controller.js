...
const createBannerImage = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let userObj = yield user_model_1.User.findById(userId).exec();
        if (!userObj) {
        ...
        yield user_model_1.User.findByIdAndUpdate(userObj._id, { $inc: { numberOfSales: -1, saleDays: -dateDiff } }).exec();
