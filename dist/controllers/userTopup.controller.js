...
const buyTopup = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield user_model_1.User.findByIdAndUpdate((_q = req === null || req === void 0 ? void 0 : req.user) === null || _q === void 0 ? void 0 : _q.userId, {
            $inc: {
...
const phonepePaymentTopUpStatusCheck = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        phoneObj.paymentInstrument = (_r = checkPaymentStatus === null || checkPaymentStatus === void 0 ? void 0 : checkPaymentStatus.data) === null || _r === void 0 ? void 0 : _r.paymentInstrument;
        orderObj = yield Payment_model_1.Payment.findByIdAndUpdate(req.params.orderId, {
            ...
            .lean()
            .exec();
        let userObj = yield user_model_1.User.findById((_s = orderObj === null || orderObj === void 0 ? void 0 : orderObj.orderObj) === null || _s === void 0 ? void 0 : _s.userId).exec();
        ...
        yield user_model_1.User.findByIdAndUpdate((_t = orderObj === null || orderObj === void 0 ? void 0 : orderObj.orderObj) === null || _t === void 0 ? void 0 : _t.userId, {
            $inc: {
        ...
        let email = (userObj === null || userObj === void 0 ? void 0 : userObj.email) ? userObj === null || userObj === void 0 ? void 0 : userObj.email : (_u = userObj === null || userObj === void 0 ? void 0 : userObj.companyObj) === null || _u === void 0 ? void 0 : _u.email;
...
const getAllTopupbyUserId = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const totalCount = yield userTopup_model_1.UserTopup.find({
            $or: [{ userId: (_v = req.user) === null || _v === void 0 ? void 0 : _v.userId }, { userId: (_w = req.query) === null || _w === void 0 ? void 0 : _w.userId }],
        }).countDocuments();
        TopupArr = yield userTopup_model_1.UserTopup.find({ $or: [{ userId: (_x = req.user) === null || _x === void 0 ? void 0 : _x.userId }, { userId: (_y = req.query) === null || _y === void 0 ? void 0 : _y.userId }] })
            .skip((pageValue - 1) * limitValue)
            .limit(limitValue)
            .lean()
            .sort({ endDate: -1 })
