        ...
        if (paymentObj && (paymentObj === null || paymentObj === void 0 ? void 0 : paymentObj.statusResponse)) {
            if (((_c = paymentObj === null || paymentObj === void 0 ? void 0 : paymentObj.statusResponse) === null || _c === void 0 ? void 0 : _c.status) === 'CHARGED') {
                return res.status(200).json({
                    ...
                    date_created: (_h = paymentObj === null || paymentObj === void 0 ? void 0 : paymentObj.statusResponse) === null || _h === void 0 ? void 0 : _h.date_created,
                    last_updated: (_j = paymentObj === null || paymentObj === void 0 ? void 0 : paymentObj.statusResponse) === null || _j === void 0 ? void 0 : _j.last_updated,
                    customer_email: (_k = paymentObj === null || paymentObj === void 0 ? void 0 : paymentObj.statusResponse) === null || _k === void 0 ? void 0 : _k.customer_email,
                    customer_phone: (_l = paymentObj === null || paymentObj === void 0 ? void 0 : paymentObj.statusResponse) === null || _l === void 0 ? void 0 : _l.customer_phone,
                    customer_id: (_m = paymentObj === null || paymentObj === void 0 ? void 0 : paymentObj.statusResponse) === null || _m === void 0 ? void 0 : _m.customer_id,
                    status: (_o = paymentObj === null || paymentObj === void 0 ? void 0 : paymentObj.statusResponse) === null || _o === void 0 ? void 0 : _o.status,
                });
            }
        }
