...
const getLeadsBycreatedById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let LeadArr = [];
        let latestSubscription = yield userSubscription_model_1.UserSubscription.findOne({ userId: (_e = req.params) === null || _e === void 0 ? void 0 : _e.id }).exec();
        LeadArr = yield leads_model_1.Lead.find({ createdById: (_f = req.params) === null || _f === void 0 ? void 0 : _f.id }).sort({ createdAt: -1 }).lean().exec();
