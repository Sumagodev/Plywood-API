...
router.post('/applications', applyfordealership_controller_1.createApplication);
router.get('/applications', applyfordealership_controller_1.getApplications); // You can pass dealershipOwnerId or userId as query parameters
