...
const SendBrevoMail = (subject, to, htmlContent, attachment = []) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let data = {
            sender: {
                "name": "Plywood Bazar",
        ...
        if (attachment && (attachment === null || attachment === void 0 ? void 0 : attachment.length) > 0) {
