...
const stateDetail_routes_1 = __importDefault(require("./routes/stateDetail.routes"));
const BannerImage_routes_1 = __importDefault(require("./routes/BannerImage.routes"));
...
app.use("/stateDetail", stateDetail_routes_1.default);
...
app.use("/dealershipOwnerRoutes", dealershipOwnerRoutes_routes_1.default);
app.use("/dealershipUserRoutes", dealershipUesrRoutes_routes_1.default);
app.use("/BannerImage", BannerImage_routes_1.default);
